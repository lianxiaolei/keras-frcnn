...
def get_data(input_path):
    """
    Get the train-val and test data with the format pascal_voc_2007
    :param input_path:
    :return:
    """
    all_imgs = []
    ...
    data_paths = [os.path.join(input_path, s) for s in ['VOC2007']]  # add data paths

    print('Parsing annotation files')

    for data_path in data_paths:
        # split trainval test dataset
